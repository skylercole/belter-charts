...
export const BODIES: BodyDef[] = [
  ...
  { id: "phobos", name: "Phobos", kind: "moon", color: "#9a8f85", periodDays: 0.319, radiusKm: 11.3, moon: { parent: "mars", kepler: { aKm: 9376, periodDays: 0.3189, phaseDeg: 0 } } },
  { id: "deimos", name: "Deimos", kind: "moon", color: "#a89d92", periodDays: 1.263, radiusKm: 6.2, moon: { parent: "mars", kepler: { aKm: 23_463, periodDays: 1.2624, phaseDeg: 120 } } },
  ...
  { id: "phoebe", name: "Phoebe", kind: "moon", color: "#8a8078", periodDays: 550.5, radiusKm: 106.5, moon: { parent: "saturn", kepler: { aKm: 12_960_000, periodDays: -550.5, phaseDeg: 250 } } },
