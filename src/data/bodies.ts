...
export interface BodyDef {
  ...
  polarScale?: number;
  /** No surface to land on; arrivals end in orbit instead. */
  gasGiant?: true;
...
export const BODIES: BodyDef[] = [
  ...
  { id: "jupiter", name: "Jupiter", kind: "planet", gasGiant: true, color: "#c9a06c", periodDays: 4333, radiusKm: 69_911, texture: "jupiter.jpg", polarScale: 0.935, spinHours: 9.93, focusDistKm: 2_450_000 },
  ...
  {
    id: "saturn", name: "Saturn", kind: "planet", gasGiant: true, color: "#d8bd8a", periodDays: 10_759, radiusKm: 58_232,
  ...
  { id: "uranus", name: "Uranus", kind: "planet", gasGiant: true, color: "#9fd0d4", periodDays: 30_687, radiusKm: 25_362, texture: "uranus.jpg", spinHours: -17.24 },
  { id: "neptune", name: "Neptune", kind: "planet", gasGiant: true, color: "#6081d6", periodDays: 60_190, radiusKm: 24_622, texture: "neptune.jpg", spinHours: 16.11 },
...
/** How a flight to this body ends: clamps, skids, orbit, or holding station. */
export type ArrivalMode = "dock" | "land" | "orbit" | "hold";

export function arrivalMode(def: BodyDef | undefined): ArrivalMode {
  if (!def) return "dock";
  if (def.kind === "construct") return "hold";
  if (def.gasGiant) return "orbit";
  if (def.kind === "planet" || def.kind === "moon") return "land";
  return "dock"; // station, smallbody
}
